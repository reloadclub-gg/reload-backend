...
STRIPE_PUBLIC_KEY = config(
    'STRIPE_API_KEY',
    'pk_test_51Nbo9mE5bET5oNsph82quT2BFFc0vy5e5uDR1IOeYmw7BUhQO73sdNhjyJB6CdooLF1XbGclFRUeov7b8tAjTa9W00hDodhUId',
)
STRIPE_SECRET_KEY = config(
    'STRIPE_API_KEY',
    'sk_test_51Nbo9mE5bET5oNspI2nuXXo2zZKZj08mEVdTCC1VRfUVwMJdcIMDr9gR2DHvGxqoCjDoxHArPGpimRkbC1qlIybc00kjy8TyY7',
)
