...
class SomePlayersMixin:
    ...
    def setUpTestData(cls):
        ...
        cls.online_unverified_user = baker.make(User, email='online_unverified_user@example.com')
